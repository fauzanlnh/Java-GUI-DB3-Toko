 ...
 * @author Fauzan13
 */
public class FPersediaanBarangUser extends javax.swing.JFrame {

    /**
     * Creates new form FPersediaanBarang
     */
    Connection koneksi;
    public FPersediaanBarangUser() {
        initComponents();
    koneksi = (Connection) DatabaseConnection.getKoneksi("localhost", "3306", "root", "", "db_tokok");
        showData();
        SelectComboBox();
                setDefaultCloseOperation(FPersediaanBarangUser.HIDE_ON_CLOSE);
  ...
  public void SelectComboBox(){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FPersediaanBarangUser.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FPersediaanBarangUser().setVisible(true);
            }
        });
    }
