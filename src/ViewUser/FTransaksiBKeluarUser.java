 ...
 * @author Fauzan13
 */
public class FTransaksiBKeluarUser extends javax.swing.JFrame {
    ...
    private void btnInsertActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnInsertActionPerformed
        try {
            ...
            Logger.getLogger(FTransaksiBKeluarUser.class.getName()).log(Level.SEVERE, null, ex);
        }
        simpan();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FTransaksiBKeluarUser.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FTransaksiBKeluarUser().setVisible(true);
            }
        });
    }
