 ...
 * @author Fauzan13
 */
public class FTransaksiBMasukUser extends javax.swing.JFrame {
    ...
    public FTransaksiBMasukUser() {
        initComponents();
        koneksi = (Connection) DatabaseConnection.getKoneksi("localhost", "3306", "root", "", "db_tokok");
        showData();
           setDefaultCloseOperation(FTransaksiBMasukUser.HIDE_ON_CLOSE);
...
cari();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FTransaksiBMasukUser.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FTransaksiBMasukUser().setVisible(true);
            }
        });
    }
