 ...
 * @author Fauzan13
 */
public class FormPelangganUser extends javax.swing.JFrame {
    ...
    public FormPelangganUser() {
        initComponents();
        koneksi = (Connection) DatabaseConnection.getKoneksi("localhost", "3306", "root", "", "db_tokok");
    showData();
    AutoNumber();
           setDefaultCloseOperation(FormPelangganUser.HIDE_ON_CLOSE);
  ...
  //      evt.consume();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormPelangganUser.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormPelangganUser().setVisible(true);
            }
        });
    }
