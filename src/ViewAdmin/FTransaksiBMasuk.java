...
public class FTransaksiBMasuk extends javax.swing.JFrame {
    ...
    private void klik() {
        ...
        String getTanggal = tblPengguna.getValueAt(tblPengguna.getSelectedRow(), 5).toString();
...
int baris;
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        try {
            Statement stmt = koneksi.createStatement();
            String query = "DELETE FROM t_bmasuk WHERE kode_barang = '" + delete + "' and tgl_masuk = '" + tanggal + "';";
            int berhasil = stmt.executeUpdate(query);
            if (berhasil == 1) {
